# escape-dismissal Specification

## Purpose

Scoped Escape key handling: dismiss overlays and cancel in-progress capture before route navigation; expanded player does not collapse on Escape alone.
