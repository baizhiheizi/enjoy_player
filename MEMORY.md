...
## Backlog progress
- Latest run (2026-08-14 run2, run id 31807339220): created draft PR `repo-assist/perf-case-conversion-ascii-2026-08-14` (commit `537774e`) folding ASCII uppercase inline in the recursive JSON-key walkers (`_camelToSnakeToken` / `_snakeToCamelToken`) without per-char allocation; refreshed monthly summary #522.
